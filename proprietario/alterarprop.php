...
<body>
  ...
  <?php
    ...
    if (isset($_REQUEST['cadastrar'])) {
      ...
      $retorno = pg_query($db, "update proprietario set nome = '$nome', cpf = '$cpf', fone = '$fone', email = '$email' where id = $id");
      if ($retorno) {
        $sucesso = true;
      }else{
          echo '<div class="alert alert-danger alert-dismissable">
                        <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
                        <strong>Erro!</strong> Problema ao editar proprietario!'.$retorno.'
                      </div>' ;
      }
...
//Busca os dados
    ...
    $result = pg_query($db, "select nome, cpf, fone, email from proprietario where id = $id");
   ...
   ?>
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        <h2 class="text-center">Alterar Proprietário</h2>
        <hr>
        <div class="row">
